...
Version  : 1.0.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/stringmagic_1.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/stringmagic_1.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703176369
...
/usr/lib64/R/library/stringmagic/tests/stringmagick_tests.R

%files lib
%defattr(-,root,root,-)
/usr/lib64/R/library/stringmagic/libs/stringmagic.so
/usr/lib64/R/library/stringmagic/libs/stringmagic.so.avx2
/usr/lib64/R/library/stringmagic/libs/stringmagic.so.avx512

...
Version  : 1.2.0
Release  : 9
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/stringmagic_1.2.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/stringmagic_1.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745246357
